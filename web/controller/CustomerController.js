...
function addCustomerToDB(customerObject){

    var cusDetail={
        id:customerObject.getCustomerId(),
        name:customerObject.getCustomerName(),
        gender:customerObject.getGender(),
...
function deleteCustomer(){
    ...
    $.ajax({
        url:"customer?cusId="+$("#customerId").val(),
        method:"DELETE",
...
function searchIfCustomerAlreadyExists(){
    $.ajax({
        url:"customer?option=SEARCH&cusId="+$("#customerId").val(),
        method:"GET",
        success:function (response) {
        ...
        error:function (ob, statusText, error) {
            search = false;
            alert(statusText+" "+"No Such Customer");
            loadAllCustomer();
        }
    });
}
...
function updateCustomer(customerObject){
...
$("#btnSearchCustomer").click(function () {
    $.ajax({
        url:"customer?option=SEARCH&cusId="+$("#searchCustomer").val(),
        method:"GET",
        success:function (response) {
